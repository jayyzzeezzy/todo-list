...
function deleteTaskFromDom(e) {
    ...
    _task_js__WEBPACK_IMPORTED_MODULE_0__.spliceTaskList(projectIndex, taskIndex);
...
function renderHome() {
    ...
    projects.forEach((project) => {
        project.task.forEach(todo => {
            _task_js__WEBPACK_IMPORTED_MODULE_0__.taskList.push(todo);
        });
    });
