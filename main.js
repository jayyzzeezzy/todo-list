...
function renderToday() {
    ...
    const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(), "yyyy-MM-dd");
    const projects = _project_js__WEBPACK_IMPORTED_MODULE_1__.getLocalStorage();
    const todos = _task_js__WEBPACK_IMPORTED_MODULE_0__.resetTaskList();
    projects.forEach(project => {
        project.task.forEach(todo => {
...
function renderWeek() {
    ...
    projects.forEach(project => {
        project.task.forEach(todo => {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isThisWeek)(todo.dueDate)) {
                todos.push(todo);
            }
        })
    });
